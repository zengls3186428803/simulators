...
void init(){
	//simulate object-oriented with function pointer;
	...
	event_manager.insert = insert;
	event_manager.get_event = get_event;
	event_manager.delete = delete;
	event_manager.search_by_who_what = search_by_who_what;
	event_manager.show = show;
